                          ...
                          children: [
                            Expanded(
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  "https://picsum.photos/seed/hotel_${index}_main/400/300",
                            ...
                            SizedBox(
                              ...
                              child: Row(
                                children: [
                                  Expanded(child: _miniImage("https://picsum.photos/seed/h_${index}_1/100/100")),
                                  const SizedBox(width: 4),
                                  Expanded(child: _miniImage("https://picsum.photos/seed/h_${index}_2/100/100")),
                                  const SizedBox(width: 4),
                                  Expanded(
                                    child: Container(
                                      decoration: BoxDecoration(
